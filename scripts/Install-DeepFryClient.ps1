...
if (-not $resolvedExecutablePath.EndsWith('.exe', [StringComparison]::OrdinalIgnoreCase)) {
    throw 'ExecutablePath harus menunjuk ke DeepFry.Client.exe.'
}
...
New-Service `
    ...
    -Description 'DeepFry Client untuk manajemen PC laboratorium.' `
...
& sc.exe failure 'DeepFry Client' reset= 86400 actions= restart/5000/restart/5000/restart/5000 | Out-Null
